...
### 🍓11/28（150d） 8h/1308h
**🐰今日やったこと**
- [x] 卒制（デプロイ時のエラー解消、ページの更新、マイページのバック連携）

**🐣感想**

昨日の仮説通りで沼抜けられました〜！
ページの更新でupdateアクション作って、マイページの判定はバックにさせる構造にしました！
***
### 🍓11/30（152d） 4h/1317h

**🐰今日やったこと**
- [x] 卒制（本リリースのISSUE途中まで）
- [x] **ビジネスマナー講座＜テキスト編＞** アーカイブ視聴（すごくためになりました）

**🐣感想**

本リリースに向けてISSUEの整理をしました。
MVPのときは全くわかないイメージの中で、「これ本当にできるのか？」と思いながら、記事やchatGPTを頼りにISSUEを作成していました。
しかし、今はもう少し解像度が高くったようで、ISSUEが思いつきます！嬉しい😊
明日には提出して、実装も再会していきたいところ！
***
