...
できることなら正規表現とメソッドを使いこなしてシンプルでキレイなコードを書きたいですが、現状は知識不足＆経験不足で長いコードでかくことしかできない😭
できるだけPaizaでたくさんの問題にふれていきたいです！！
Rubyのモジュールはクラス同様難しいですね〜💦
***
### 🍓9/20（161d） 4h/900h
**🐰今日の学習**
- [x] Paiza Cランク
...
Paizaは知らないメソッドとかでてくると全然応用がきかないので、たくさん問題を解いていきたいです！
ミニアプリウィークでも何か出したいので、今日はその案を考えてましたが、まだまとまりません💦
***
### 🍓9/21（162d） 3h/903h
**🐰今日の学習**
- [x] Paiza Cランク
...
- [x] Paiza Cランク
- [x] ミニアプリウィークの環境構築
- [x] 第5回RUNTEQ祭プレゼン会 Day1資料作り
 
**🐣感想**
 
よくわからぬまま、今日はバックとフロントをわけて環境構築してみました！
ひとまずできた〜が、理解に務めなけれな💦
***
### 🍓9/23（164d） 8h/916h
**🐰今日の学習**
- [x] ミニアプリウィークのアプリ開発（バックエンド実装）
- [x] 第5回RUNTEQ祭プレゼン会 Day1登壇
 
**🐣感想**
 
第5回RUNTEQ祭プレゼン会 、めっちゃ緊張しました😲
そしてやはり、技術の話をもう少しできるようになりたいですね〜 :smiling_face_with_tear: 
ミニアプリは、ひいひいい〜しながら作ってます💦
ミニアプリウィークには間に合わなさそうなので焦り中😭
今日はまず、バックとフロントでうまいことデータがわたっていなくて詰まり、次にバックはfly.ioにデプロイしたけどブロックされているとエラー。
ブロックされないように記載してもキャッシュが残っているのかエラーが続く…
明日に持ち越しだ〜！！！！
***
### 🍓9/24（165d） 8h/924h
**🐰今日の学習**
...
Top画面を実装し、バックとフロントをそれぞれデプロイ、バックとフロントの連携までできた〜！
しかし〆切はもう明後日😲
明日はひとまずアニメーションつけて、明後日openAI入れられたらよしとしよう！
***
### 🍓9/24（165d） 8h/924h
**🐰今日の学習**
- [x] アプリ開発
...
フロントの実装はほぼ終わり！
しかし、バックエンドのデプロイ時にデータベースへの接続が確立できないらしく、デプロイ失敗し続ける…
環境変数、パスワード変えたり初期化したり色々するもだめでした。。
今日はもう寝ます…😭
これができないとミニアプリだしぇません😭😭😭
***
### 🍓9/26（167d） 8h/940h
...
結局バックとフロントのやりとりはできましぇんでした😭
ひとまず、ミニアプリウィークには間に合わなかったのでフロントのみで提出。
卒制でも使う予定なので、卒制入る前に、フロントとバックのデータの受渡しについてはある程度習得しなければ！
時間ギリギリまでエラー対応してて、OGP画像とかXshareとかやり忘れてた💦
中途半端なものをだすことになり反省。。
